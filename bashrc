...
##DPPs
alias cds1="cd /home/pkpansar/learn_tour/code/learn_to_optimize"
alias cdd="cd /home/pkpansar/learn_tour/data"
alias cds2="cd /home/pkpansar/learn_tour/code/attention-learn-to-route"
...
scpf() {
	scp "$1" pkpansar@dry.int.europe.naverlabs.com:/nfs/team/mlo/ppansari/"$2"
}

scpd() {
	scp -r "$1" pkpansar@dry.int.europe.naverlabs.com:/nfs/team/mlo/ppansari/"$2"
}

# added by Anaconda2 installer
export PATH="/home/pankaj/anaconda2/bin:$PATH"
# . /home/pankaj/anaconda2/etc/profile.d/conda.sh  # commented out by conda initialize

#Zotero
export PATH="/home/pkpansar/tool/Zotero_linux-x86_64:$PATH"

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/pkpansar/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/pkpansar/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/pkpansar/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/pkpansar/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
alias vimr="vim scp://pkpansar@vallis-1//home/pkpansar/tour_generation/code/attention-learn-to-route/train.py"
